                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 mb-16">
                    ...
                    <div className="space-y-6">
                        ...
                        <div className="flex gap-4">
                            <a href="https://www.instagram.com/encore.iet?igsh=djgwcXEwOTluYm44" target="_blank" rel="noopener noreferrer" className="text-gray-400 hover:text-gold transition-colors">
                                <Instagram size={20} />
                            </a>
                            <a href="https://www.facebook.com/people/Encore-Cultural-Fest-of-IET-Lucknow/61586614022230/?rdid=OCHbTbSIvEOrbszq&share_url=https%3A%2F%2Fwww.facebook.com%2Fshare%2F1L4xyzBFke%2F%3Fref%3D1" target="_blank" rel="noopener noreferrer" className="text-gray-400 hover:text-gold transition-colors">
                                <Facebook size={20} />
                            </a>
                            <a href="https://youtube.com/@encore_iet?si=G0KNFpQSFo7CkRqc" target="_blank" rel="noopener noreferrer" className="text-gray-400 hover:text-gold transition-colors">
                                <Youtube size={20} />
                            </a>
                            <a href="https://www.linkedin.com/school/ietlucknow/posts/?feedView=all" target="_blank" rel="noopener noreferrer" className="text-gray-400 hover:text-gold transition-colors">
                                <Linkedin size={20} />
                            </a>
                        </div>
                    </div>
